...
namespace engine
{
	...
	engine::InputMappingContext& InputSystem::get_input_mapping_context( )
	{
	...
	void InputSystem::press_key( binding::key_t key )
	{
	...
	void InputSystem::release_key( binding::key_t key )
	{
	...
	void InputSystem::press_button( binding::btn_t button )
	{
	...
	void InputSystem::release_button( binding::btn_t button )
	{
	...
	void InputSystem::dispatch_pressed( )
	{
		...
		for ( auto button : buttons_pressed_this_frame_ )
		{
