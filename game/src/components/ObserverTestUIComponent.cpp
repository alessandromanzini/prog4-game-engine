...
game::ObserverTestUIComponent::ObserverTestUIComponent( engine::UIController& owner, bool gamepad )
	: UIComponent( owner )
	, Observer( )
	, gamepad_( gamepad )
{
...
void game::ObserverTestUIComponent::render( )
{
	if ( gamepad_ )
	{
...
void game::ObserverTestUIComponent::notify( engine::UID event, engine::Subject* /* subject */, engine::event::broadcast_value_variant_t value )
{
